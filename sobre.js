...
const textosSobre = {
    ...
    'premio': `Em 2024, Amanda teve a oportunidade de participar de um desafio na Record. Prêmio Conquistado: R$ 10.000,00 (dez mil reais). Uso do Prêmio: Com o valor do prêmio, Amanda abriu sua sala de cursos, separando o espaço de ensino do salão de atendimento. Se for de seu interesse você pode ver o video em que eu ganhei esse prêmio: ` 
};
